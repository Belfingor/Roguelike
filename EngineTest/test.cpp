...
{
	GameEngine::Vector2D<float> vector;
...
{
	GameEngine::Vector2D<float> vector(5.f, -3.f);
...
{
	GameEngine::Vector2D<float> first(4.f, -3.f);
	GameEngine::Vector2D<float> second(-4.f, 9.f);
	GameEngine::Vector2D<float> third = first + second;
...
{
	GameEngine::Vector2D<float> first(4.f, -3.f);
	GameEngine::Vector2D<float> second = -first;
...
{
	GameEngine::Vector2D<float> first(4.f, -3.f);
	GameEngine::Vector2D<float> second = -1.5f * first;
...
{
	GameEngine::Vector2D<float> first(4.f, -3.f);
	GameEngine::Vector2D<float> second = first * -1.5f;
...
{
	GameEngine::Vector2D<float> first(4.f, -3.f);
	GameEngine::Vector2D<float> second(4.f, -3.f);
	GameEngine::Vector2D<float> third(4.f, -6.2f);
...
{
	GameEngine::Vector2D<float> first(1.f, -3.f);
	GameEngine::Vector2D<float> second(6.f, -2.f);
